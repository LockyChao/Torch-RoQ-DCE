...
def parse_args():
    ...
    parser.add_argument("--input_folder", type=str, default="/mnt/LiDXXLab_Files/Chaowei/Low-dose Study/AI_Fitting/Input_extTofts_fitkep/", help="Folder with .mat files for inference")
